                ...
                for (let user of participants) {
                    ...
                    try {
                        ...
                        text = (action === 'add' ? (chat.sWelcome || this.welcome || conn.welcome || 'Welcome, @user!').replace('@subject', await this.getName(id)).replace('@desc', groupMetadata.desc?.toString() || '*𝙂𝙧𝙪𝙥𝙤 𝙂𝙚𝙣𝙞𝙖𝙡 | 𝘾𝙤𝙤𝙡 𝙂𝙧𝙤𝙪𝙥 😼*') :
                            ...
                            this.sendHydrated(id, text, groupMetadata.subject, apii.data,                                                       'https://github.com/KrzzLpzz/UnknownMD', '𝙐𝙣𝙠𝙣𝙤𝙬𝙣𝙈𝘿-𝙈𝘿', null, null, [
...
global.dfail = (type, m, conn) => {
    let msg = {
        ...
        unreg: '╰⊱⚠️⊱ *𝘼𝘿𝙑𝙀𝙍𝙏𝙀𝙉𝘾𝙄𝘼 | 𝙒𝘼𝙍𝙉𝙄𝙉𝙂* ⊱⚠️⊱╮\n\n_*¡Qué esperas para estar Verificando(a) en UnknownBot-MD! Usa el comando #verificar*_\n_*What are you waiting for to be Verifying with UnknownBot-MD! Use the #verify command*_',
