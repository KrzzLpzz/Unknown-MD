...
const estilo = { key: {  fromMe: false, participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "50497132870-1625305606@g.us" } : {}) },
message: { 
...
const estiloaudio = { key: {  fromMe: false, participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "50497132870-1625305606@g.us" } : {}) },
message: { 
